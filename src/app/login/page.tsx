"use client";
import { ColoredGoogleicon, PaperPlaneIcon } from "@/assets/icons";
import { useRouter } from "next/navigation";
import loginImage from "@/assets/images/dashboard-images/lock and key.png";
  ...
  return (
    <div className="p-3 md:p-0 h-full md:h-screen w-screen flex flex-col md:flex-row bg-gray-100 text-black font-sans">
      ...
      <fieldset className="md:w-[50%] w-full justify-center items-center md:items-start h-full flex gap-5 flex-col">
        ...
        />
        <input
          className="p-3 text-lg rounded-lg border w-full md:w-[65%] border-gray-400"
          type="password"
          name="password"
          id="password"
